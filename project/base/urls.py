...
urlpatterns = [
    ...
    path('login/helpme_send_query/', views.helpme_send_query, name='helpme_send_query'),
    path('creating_iam_user/', views.creating_iam_user, name='creating_iam_user'),
    path('my_iam_users/remove_iamuser_ajax/', views.remove_iamuser_ajax, name='remove_iamuser_ajax'),
]